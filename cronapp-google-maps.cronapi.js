(function() {
   ...
   */
  this.cronapi.maps.isInitialized = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id) {
   ...
   * @description createLatLng
   */
  this.cronapi.maps.centralizeMap = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id, /** @type {ObjectType.STRING} @description {{latitude}} */ latitude, /** @type {ObjectType.STRING} @description {{longitude}} */ longitude ) {
   ...
   */
  this.cronapi.maps.setAdvancedMapOptions = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id, /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions  ) {
      if(advancedOptions){
        try{
          var map = document.getElementById(id)._map;
   ...
   * @description createMarkerDescription
   */
  this.cronapi.maps.createMarker = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{markerId}} */ markerId, /** @type {ObjectType.STRING} @description {{title}} */ title, /** @type {ObjectType.STRING} @description {{point}} */ point ,/** @type {ObjectType.STRING} @description {{icon}} */ icon , /** @type {ObjectType.STRING} @description {{infoWindow}} */ infoWindow , /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions    ) {
      var map = document.getElementById(id)._map;
      var marker;
   ...
   * @description createMarkerDescription
   */
  this.cronapi.maps.setAdvancedMarkerOptions = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{markerId}} */ markerId, /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions  ) {
      if(advancedOptions){
        try{
          var map = document.getElementById(id)._map;
          var marker;
   ...
   * @description createMarkerDescription
   */
  this.cronapi.maps.changeMapZoom = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id, /** @type {ObjectType.STRING} @description {{zoom}} @blockType util_dropdown @keys 16|18|10  @values street|buildings|city  */ zoom ) {
      var map = document.getElementById(id)._map;
   ...
   */
  this.cronapi.maps.getPropertyFromMarker = function(/** @type {ObjectType.OBJECT} @description {{id}} @blockType ids_from_screen*/ id,/** @type {ObjectType.STRING} @description {{markerId}}*/ markerId, /** @type {ObjectType.STRING} @description {{type}} @blockType util_dropdown @keys latitude|longitude|icon|title|infoWindow  @values latitude|longitude|icon|title|infoWindow  */ property ) {
      var map = document.getElementById(id)._map;
   ...
   */
  this.cronapi.maps.createAutoComplete = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{type}} @blockType util_dropdown @keys geocode|address|establishment  @values geocode|address|establishment  */ searchType ,    /** @type {ObjectType.STRING} @description {{bounds}} */ searchBounds,  /** @type {ObjectType.STRING} @description {{type}} @blockType util_dropdown @keys true|false  @values true|false  */ isStrictSearch ,/** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions,  /** @type {ObjectType.STATEMENTSENDER} @description {{statement}} */ statement ) {
      var map = document.getElementById(id)._map;
   ...
   * @description createAutoCompleteDescription
   */
  this.cronapi.maps.drawCircle = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{circleId}} */ circleId, /** @type {ObjectType.STRING} @description {{centerPoint}} */ centerPoint,  /** @type {ObjectType.STRING} @description {{radius}} */ radiusInMeters , /** @type {ObjectType.STRING} @description {{fillColor}} */ fillColor, /** @type {ObjectType.STRING} @description {{strokeColor}} */  strokeColor,  /** @type {ObjectType.STRING} @description {{fillOpacity}} */ fillOpacity , /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions) {
      var map = document.getElementById(id)._map;
      var circle;
   ...
   * @description createAutoCompleteDescription
   */
  this.cronapi.maps.drawRectangle = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{rectId}} */ rectId, /** @type {ObjectType.STRING} @description {{bounds}} */ bounds,   /** @type {ObjectType.STRING} @description {{fillColor}} */ fillColor, /** @type {ObjectType.STRING} @description {{strokeColor}} */  strokeColor,  /** @type {ObjectType.STRING} @description {{fillOpacity}} */ fillOpacity , /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions) {
      var map = document.getElementById(id)._map;
      var rect;
   ...
   * @description createAutoCompleteDescription
   */
  this.cronapi.maps.drawLine = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{polygonId}} */ polylineId,  /** @type {ObjectType.STRING} @description {{path}} */ coordsPath,  /** @type {ObjectType.STRING} @description {{strokeColor}} */  strokeColor,  /** @type {ObjectType.STRING} @description {{strokeOpacity}} */ strokeOpacity, /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions) {
      var map = document.getElementById(id)._map;
      var polyline;
   ...
   * @description createAutoCompleteDescription
   */
  this.cronapi.maps.drawPolygon = function(/** @type {ObjectType.OBJECT} @description {{createChartId}} @blockType ids_from_screen*/ id,  /** @type {ObjectType.STRING} @description {{polygonId}} */ polygonId,  /** @type {ObjectType.STRING} @description {{path}} */ coordsPath,  /** @type {ObjectType.STRING} @description {{fillColor}} */  fillColor,/** @type {ObjectType.STRING} @description {{fillOpacity}} */  fillOpacity,/** @type {ObjectType.STRING} @description {{strokeColor}} */  strokeColor,  /** @type {ObjectType.STRING} @description {{strokeOpacity}} */ strokeOpacity, /** @type {ObjectType.STRING} @description {{advancedOptions}} */ advancedOptions) {
      var map = document.getElementById(id)._map;
      var polygon;
   ...
   */
  this.cronapi.maps.geocoder = function(/** @type {ObjectType.OBJECT} @description {{request}} */ requestAddress, /** @type {ObjectType.OBJECT} @description {{requestBounds}} */ requestBounds, /** @type {ObjectType.OBJECT} @description {{requestAdvancedOptions}} */ requestAdvancedOptions ,  /** @type {ObjectType.STATEMENTSENDER} @description {{statement}} */ statement ) {
      var request= {
